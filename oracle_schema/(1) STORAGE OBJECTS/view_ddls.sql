...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UOFFICE"."STUDENT_DISCIPLINARY_LOG" ("STUDENT_ID", "STUDENT_NAME", "FACULTY_NAME", "ACTION_DATE", "DESCRIPTION", "ACTION_DETAILS") AS 
  SELECT
  s.student_id,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UOFFICE"."STUDENT_EXAM_SCHEDULE" ("STUDENT_ID", "STUDENT_NAME", "COURSE_NAME", "EXAM_DATE", "SEMESTER_CODE", "SEMESTER_START", "SEMESTER_END") AS 
  SELECT 
  s.student_id,
  s.name AS student_name,
  c.course_name,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UOFFICE"."STUDENT_HOSTEL_STATUS" ("STUDENT_ID", "STUDENT_NAME", "HOSTEL_NAME", "ROOM_NUMBER", "ALLOCATION_DATE", "CAPACITY") AS 
  SELECT
  s.student_id,
  s.name AS student_name,
